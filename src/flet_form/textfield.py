...
class TextField(FletTextField, FormInput[str]):
    ...
    def __init__(
        self,
        rules: FormInputRules[Optional[str]] = None,
        #
        # TextField specific
        #
    ...
    @property
    def _value_for_validation(self) -> Optional[str]:
        return self.value
